...
import type { Json } from "../oAS310Playground.schemas";
...
export const getPostJsonRequiredNullableOptionalMockHandler = (
  ...
  return http.post("*/json/:required/:nullable/:optional", async () => {
    ...
    return new HttpResponse(
      JSON.stringify(
        overrideResponse
          ? overrideResponse
          : getPostJsonRequiredNullableOptionalResponseMock(),
      ),
      {
        status: 200,
        headers: {
